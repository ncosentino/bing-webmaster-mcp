#!/usr/bin/env python3
"""
Generate articles.md from the Dev Leader Bing Webmaster Tools MCP tag page.
...
_TAG_URL = 'https://www.devleader.ca/tags/BingWebmasterMcp'
...
def generate_markdown(articles: list[dict]) -> str:
    ...
    lines = [
        ...
        "",
        "!!! tip \"Stay Updated\"",
        "    Follow [Dev Leader](https://www.devleader.ca) for articles about MCP servers, Bing Webmaster Tools, and C#/.NET development.",
        "",
    ]
