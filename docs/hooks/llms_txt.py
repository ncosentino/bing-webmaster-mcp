...
> Zero-dependency MCP server that exposes the Bing Webmaster Tools API to AI assistants.

The Bing Webmaster Tools MCP server provides native binaries for Go and C#.
It exposes MCP tools covering site management, sitemaps, URL submission
(including IndexNow), crawl diagnostics, URL/index inspection, and search
analytics directly to AI assistants like Claude, GitHub Copilot, and Cursor.
